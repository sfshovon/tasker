...
export default function AddTaskModal({ onSave, taskToUpdate, onCloseClick }) {
	...
	return (
		<>
			...
			<form className="mx-auto my-10 w-full max-w-[740px] rounded-xl border border-[#FEFBFB]/[36%] bg-zinc-800 p-9 max-md:px-4 lg:my-20 lg:p-11 z-10 absolute top-1/4 left-1/3">
